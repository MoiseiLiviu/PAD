...
type AuthServiceClient interface {
	RegisterUser(ctx context.Context, in *RegisterUserInput, opts ...grpc.CallOption) (*RegistrationResponse, error)
...
func (c *authServiceClient) RegisterUser(ctx context.Context, in *RegisterUserInput, opts ...grpc.CallOption) (*RegistrationResponse, error) {
...
func (c *authServiceClient) LoginUser(ctx context.Context, in *LoginInput, opts ...grpc.CallOption) (*LoginResponse, error) {
...
type AuthServiceServer interface {
	RegisterUser(context.Context, *RegisterUserInput) (*RegistrationResponse, error)
...
func (UnimplementedAuthServiceServer) RegisterUser(context.Context, *RegisterUserInput) (*RegistrationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterUser not implemented")
}
func (UnimplementedAuthServiceServer) LoginUser(context.Context, *LoginInput) (*LoginResponse, error) {
...
func _AuthService_RegisterUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).RegisterUser(ctx, req.(*RegisterUserInput))
	}
...
func _AuthService_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).LoginUser(ctx, req.(*LoginInput))
	}
	return interceptor(ctx, in, info, handler)
}
